...
echo DEVICE_TARGET='iPad Air (8.4 Simulator)' APP_BUNDLE_PATH=$APP_BUNDLE_PATH_VAR bundle exec cucumber -f rerun --out rerun.txt -p ios --tag $2
DEVICE_TARGET='iPad Air (8.4 Simulator)' APP_BUNDLE_PATH=$APP_BUNDLE_PATH_VAR  bundle exec cucumber -f rerun --out rerun.txt -p ios --tag $2