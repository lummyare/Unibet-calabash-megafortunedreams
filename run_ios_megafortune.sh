...
SCHEME_XC="MegaFortuneDreams-cal"
BUILD_CONFIG="Debug"
FEATURES_PATH="features"
ARCHITECTURE_SELECTED="i386 x86_64"
APPNAME="MegaFortuneDreams-cal"
...
echo DEVICE_TARGET='iPhone 6 Plus (8.4 Simulator)' APP_BUNDLE_PATH=$APP_BUNDLE_PATH_VAR bundle exec cucumber -f rerun --out rerun.txt -p ios --tag $2
DEVICE_TARGET='iPhone 6 Plus (8.4 Simulator)' APP_BUNDLE_PATH=$APP_BUNDLE_PATH_VAR bundle exec cucumber -f rerun --out rerun.txt -p ios --tag $2